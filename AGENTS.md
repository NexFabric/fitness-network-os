...
**Progress truth (2026-08-10):** Phase **0–15.5** on `main` is CI VERIFIED / LOCKED at merge `125a8c6` (formal lock docs PR #27). Phase **16–24 MVP** MERGED via PR #26 + remaining-MVP **#37–#42** + UI brand **#44–#45** (main `325d93d`; alembic head `q0d1e2f3a4b5`). Phase **25–26** docs/exit open — **not LOCKED**, **not production-ready**. Checklist: `docs/PROGRESS_CHECKLIST.md`. Backlog: `backend/docs/plans/REMAINING_WORK_BOARD.md`.
