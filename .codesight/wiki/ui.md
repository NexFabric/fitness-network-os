...
- **Architecture** — `frontend/public-site/src/components/Architecture.tsx`
- **Cta** — `frontend/public-site/src/components/Cta.tsx`
- **Features** — `frontend/public-site/src/components/Features.tsx`
- **Header** — `frontend/public-site/src/components/Header.tsx`
- **Hero** — `frontend/public-site/src/components/Hero.tsx`
- **Metrics** — `frontend/public-site/src/components/Metrics.tsx`
- **Pricing** — `frontend/public-site/src/components/Pricing.tsx`
