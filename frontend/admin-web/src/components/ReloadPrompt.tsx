...
export function ReloadPrompt() {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-[9999] rounded-xl border border-teal-500/30 bg-slate-900/90 p-4 shadow-xl backdrop-blur-md animate-in slide-in-from-bottom-4">
