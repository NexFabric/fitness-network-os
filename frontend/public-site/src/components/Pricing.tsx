...
const tiers = [
  {
    ...
    features: [
      "Demo kulüp ve yönetici paneli",
      "Üye, şube ve personel ekranları",
      "Kapı / turnike okuyucu (scanner) denemesi",
      "Detaylı sistem ve yetki mimarisi tanıtımı",
    ],
    cta: "Demoyu talep et",
  ...
  },
  {
    ...
    features: [
      ...
      "Dinamik QR + Turnike Tarayıcı & Mobil Uygulama",
      "Kuruş hassasiyetinde faturalama & otomatik tahsilat",
      "Gelişmiş veri izolasyonu ve güvenlik denetim kayıtları",
      "Öncelikli iş günü teknik destek",
    ],
    cta: "Teklif al",
  ...
  },
  {
    ...
    features: [
      "Merkezi çok şubeli zincir yönetim konsolu",
      "Özel donanım & API entegrasyonları",
      "Sözleşmeli Kurumsal SLA ve 7/24 Öncelikli Destek",
