...
@pytest.mark.asyncio
async def test_freeze_membership_success(
    db_session: AsyncSession, setup_membership_data: Membership
):
...
@pytest.mark.asyncio
async def test_unfreeze_membership_success(
    db_session: AsyncSession, setup_membership_data: Membership
):
    membership = setup_membership_data
    from app.api.deps import current_tenant_id_var
    ...
    # Unfreeze it
    unfrozen_membership = await service.unfreeze_membership(membership_id=membership.id)
