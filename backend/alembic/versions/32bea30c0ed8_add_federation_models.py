...
down_revision: str | Sequence[str] | None = "8d4b31a89f92"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_compliance_records_tenant_id"),
        "compliance_records",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_passport_configs_tenant_id"),
        "passport_configs",
        ["tenant_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_compliance_records_tenant_id"), table_name="compliance_records"
    )
