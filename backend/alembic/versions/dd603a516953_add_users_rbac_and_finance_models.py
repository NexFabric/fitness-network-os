...
down_revision: str | Sequence[str] | None = "c938894ffe0f"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_billing_accounts_member_id"),
        "billing_accounts",
        ["member_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_billing_accounts_tenant_id"),
        "billing_accounts",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_billing_accounts_user_id"),
        "billing_accounts",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_user_devices_device_id"), "user_devices", ["device_id"], unique=True
    )
    op.create_table(
        "user_mfa_methods",
        sa.Column("user_id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_user_roles_tenant_id"), "user_roles", ["tenant_id"], unique=False
    )
    op.create_index(
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_payment_allocations_tenant_id"), table_name="payment_allocations"
    )
    op.drop_index(
        op.f("ix_payment_allocations_payment_id"), table_name="payment_allocations"
    )
    op.drop_index(
        op.f("ix_payment_allocations_invoice_id"), table_name="payment_allocations"
    )
