...
def upgrade() -> None:
    # key_status_enum
    sa.Enum("ACTIVE", "VERIFY_ONLY", "REVOKED", name="key_status_enum").create(
        op.get_bind()
    )
    ...
    op.create_index(
        op.f("ix_signing_keys_tenant_id"), "signing_keys", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_devices_tenant_id"), "devices", ["tenant_id"], unique=False
    )
    enable_rls("devices")
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            postgresql.ENUM(
                "GRANTED", "DENIED", name="access_status_enum", create_type=False
            ),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_access_attempts_tenant_id"),
        "access_attempts",
        ["tenant_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_checkins_tenant_id"), "checkins", ["tenant_id"], unique=False
    )
    enable_rls("checkins")
    ...
    op.create_index(
        op.f("ix_offline_snapshots_tenant_id"),
        "offline_snapshots",
        ["tenant_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_offline_snapshots_tenant_id"), table_name="offline_snapshots"
    )
    op.drop_index(
