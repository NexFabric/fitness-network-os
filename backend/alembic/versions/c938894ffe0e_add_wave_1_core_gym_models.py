...
down_revision: Union[str, Sequence[str], None] = 'c938894ffe0d'
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_members_member_number'), 'members', ['member_number'], unique=False)
    ...
    op.create_index(op.f('ix_consent_definitions_tenant_id'), 'consent_definitions', ['tenant_id'], unique=False)
    ...
    op.create_table('consent_versions',
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
        sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
        sa.ForeignKeyConstraint(['definition_id'], ['consent_definitions.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_consent_versions_tenant_id'), 'consent_versions', ['tenant_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_consent_definitions_tenant_id'), table_name='consent_definitions')
