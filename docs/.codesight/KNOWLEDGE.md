# Knowledge Map — docs
> 34 notes · 2 decisions · 0 open questions

> **AI Primer:** This knowledge base has 34 notes. Key topics: close this gate one command, evidence log, close this gate checklist, run it. Most recent decision: Federation-scope reads are served **without changing any existing RLS policy and.
...
- `ops/LEGAL_APPROVAL.md` — **Status:** **UNVERIFIED** · HUMAN/LEGAL APPROVAL OPEN
- _…and 10 more_
