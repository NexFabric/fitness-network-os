# Knowledge Map — docs
> 25 notes · 2 decisions · 0 open questions

> **AI Primer:** This knowledge base has 25 notes. Key topics: run it, what this does not close. Most recent decision: Federation-scope reads are served **without changing any existing RLS policy and.
...
- `ops/S3_RUNTIME_PROOF.md` — **Date:** 2026-08-16 · **Status:** **EXECUTED against a real S3 API (MinIO)**
