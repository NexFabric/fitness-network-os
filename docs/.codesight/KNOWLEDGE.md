# Knowledge Map — docs
> 32 notes · 2 decisions · 0 open questions

> **AI Primer:** This knowledge base has 32 notes. Key topics: run it, what this does not close. Most recent decision: Federation-scope reads are served **without changing any existing RLS policy and.
