# Knowledge Map — docs
> 36 notes · 2 decisions · 0 open questions

> **AI Primer:** This knowledge base has 36 notes. Key topics: close this gate one command, evidence log, close this gate checklist, run it. Most recent decision: Federation-scope reads are served **without changing any existing RLS policy and.
...
## Recurring Themes
close this gate one command · evidence log · close this gate checklist · run it · what this does not close
