# Knowledge Map — docs
> 35 notes · 2 decisions · 0 open questions

> **AI Primer:** This knowledge base has 35 notes. Key topics: close this gate one command, evidence log, close this gate checklist, run it. Most recent decision: Federation-scope reads are served **without changing any existing RLS policy and.
...
- `ops/KMS_IAM_RUNBOOK.md` — **Date:** 2026-08-16 · **Status:** **UNVERIFIED**
- _…and 11 more_
